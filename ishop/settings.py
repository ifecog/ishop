...
SECRET_KEY = 'django-insecure-uc64g3&(*jnb51hnt1*(lx5d101cc7tz!_m$au0wc0*kyk82es'
...
CSRF_TRUSTED_ORIGINS = ['https://ishop.up.railway.app']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',
        'USER': 'postgres',
        'PASSWORD': 'f3e645BfCA5dC1cF3bd615d5fCdfAaGD',
